...
const _CONTRACT_ADDRESS = "0xc71a7ecd96fef6e34a5c296bee9533f1deb0e3c1";
...
function getProgress() {
    token.contractProgress(function(err, result) {
        if (err) return console.log(err);
        $("#mineEpoch").text(result[3]);
        $("#currentCandidate").text(result[1]);
        $("#mnReward").text(result[6] / DECIMALS);
        $("#powReward").text(result[5] / DECIMALS);
        $("#globReward").text(result[4] / DECIMALS);
        $("#mnusers").text(result[7]);
        /**
        * @title:
        */
        console.log("Fetched data from contract ");
...
/**
* @dev:
* @param function calculateNewMiningDifficulty( :
*/
            ...
            */
            function updateStatsThatHaveDependencies(stats) {
                ...
                */
                ...
                /**
                * @dev:
                * @param piechart_dataset undefined :
                * @param piechart_labels undefined :
                */
